          ...
          <div class="link-nav hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
              ...
              <li class="bg-purple-500 rounded-md">
                <Button>Hello {{ profile.name }} </Button>
              </li>
              <li class="bg-yellow-500 rounded-md">
                <Button><router-link :to="{ name: 'restos-create' }">Add Resto
                  </router-link></Button>
              </li>
      ...
      <div class="pt-5">
        ...
        <div class="max-w-screen-xl mx-auto p-4 lg:flex gap-3">
          <div class="">
            ...
            <p class="font-[Montserrat] leading-relaxed">Kami memberikan anda banyak pilihan restoran yang cocok untuk
              anda,
      ...
      <div class="max-w-screen-xl mx-auto p-4">
        ...
        <div class="mt-10 flex flex-wrap gap-8 justify-center">
          <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow" v-for="resto in restos"
            ...
            <p v-else><img class="p-8 rounded-t-lg mx-auto" src="../assets/image/broken-img.png" alt="product image" />
            </p>
            <div class="px-5 pb-2">
              <a href="#">
            ...
            <Button class="inline-block p-2 px-4 bg-blue-600 text-white rounded hover:bg-blue-800 mb-2 ml-4">
              <RouterLink :to="{ name: 'restos-show', params: { id: resto.id } }">See detail
              </RouterLink>
            </Button>
          </div>
        </div>
